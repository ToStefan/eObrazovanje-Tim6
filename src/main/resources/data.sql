...
--#Documents
INSERT INTO documents(name, file_name, uri, student_id, version, deleted) VALUES('Scanned id card', 'idcard.pdf', 'ftp://localhost/files/idcard.pdf', 1, current_timestamp(), 0);
INSERT INTO documents(name, file_name, uri, student_id, version, deleted) VALUES('Scanned high school diploma', 'file_name.pdf', 'ftp://localhost/files/file_name.pdf', 1, current_timestamp(), 0);